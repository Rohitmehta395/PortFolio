...
const Experience = () => {
  ...
  const workExperience = [
    {
      ...
      achievements: [
        "Successfully built responsive web pages",
  ...
  const projects = [
    ...
    },
    {
      ...
      highlights: [
        "Built blog publishing system with rich text editor",
        "Integrated email newsletter system",
        "Includes admin authentication, image upload functionality, and SEO optimization",
        "Implemented responsive design with Tailwind CSS",
      ],
